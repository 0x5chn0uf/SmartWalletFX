...
async def test_users_me_endpoint(test_app_with_di_container, test_di_container_with_db):
    ...
    payload = {"username": "bob_async", "email": "bob_async@example.com", "password": "Str0ng!pwd"}

    async with httpx.AsyncClient(app=test_app_with_di_container, base_url="http://test") as client:
