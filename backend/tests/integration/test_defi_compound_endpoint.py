...
def mock_w3_compound():
    ...
    mock_comptroller_contract.functions.getAssetsIn(ANY).call.return_value = [
        "0xc00e94Cb662C3520282E6f5717214004A7f26888"
    ]

    mock_ctoken_contract = MagicMock()
    mock_ctoken_contract.functions.underlying().call.return_value = (
        "0x6B175474E89094C44Da98b954EedeAC495271d0F"
    )
    mock_ctoken_contract.functions.balanceOf(ANY).call.return_value = 100 * 10**8
    mock_ctoken_contract.functions.borrowBalanceCurrent(ANY).call.return_value = (
        50 * 10**18
    )
    mock_ctoken_contract.functions.exchangeRateCurrent().call.return_value = (
        20000000000000000
    )
