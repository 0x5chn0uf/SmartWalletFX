...
ERROR_SOLUTIONS = {
    ErrorCode.SERVER_UNAVAILABLE: "💡 Start the server with: serena serve",
    ...
    ErrorCode.DATABASE_CONNECTION_FAILED: "💡 Try: serena init to reset the database",
    ...
    ErrorCode.CONFIGURATION_ERROR: "💡 Review your .serena/config.json settings",
}
