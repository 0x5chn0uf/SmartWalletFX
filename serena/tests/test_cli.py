...
from serena.cli import init_cmd, search_cmd
...
class TestCLIErrorHandling:
    ...
    def test_init_cmd_permission_error(self, capsys):
        ...
        with patch('serena.cli.init_cmd.init_database') as mock_init:
    ...
    def test_search_cmd_import_error(self, capsys):
        ...
        with patch('serena.cli.search_cmd.Memory') as mock_memory:
            ...
            assert exc_info.value.code == 1
            captured = capsys.readouterr()
            assert "❌ Missing dependency: sentence-transformers not found" in captured.out
