...
class TestAsyncEmbeddingQueue:
    ...
    @patch("serena.infrastructure.embeddings.get_default_generator")
...
class TestSearchEngineOptimizations:
    ...
    @patch("serena.infrastructure.search.search_core.get_session")
    ...
    def test_search_with_empty_embeddings(self):
        ...
        with patch(
            "serena.infrastructure.search.search_core.get_session"
        ) as mock_get_session:
...
class TestIntegratedPerformance:
    ...
    def test_end_to_end_performance(self):
        ...
        with patch(
            "serena.infrastructure.embeddings.get_default_generator"
        ) as mock_gen:
            mock_generator = Mock()
            mock_generator.load_model_now.return_value = True
            mock_generator.generate_embeddings_batch.return_value = [
