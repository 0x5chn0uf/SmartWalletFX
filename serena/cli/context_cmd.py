...
from serena.cli.common import RemoteMemory, setup_logging
from serena.core.errors import ErrorCode, get_user_friendly_message
...
def _search_semantic_memories(remote_memory: RemoteMemory, query: str, limit: int = 5) -> Tuple[List[Dict[str, Any]], int]:
    """Search Serena's semantic memories."""
    memories = []
    memory_count = 0
