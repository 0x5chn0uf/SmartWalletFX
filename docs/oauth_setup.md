...
*This guide covers OAuth integration patterns specific to the trading bot backend architecture. For general API patterns, see [API_PATTERNS.md](API_PATTERNS.md).*
